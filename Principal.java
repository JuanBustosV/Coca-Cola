...
public class Principal extends JFrame implements ActionListener{
  ...
  public Principal(){
    ...
    labelfooter = new JLabel("©" + Calendar.getInstance().get(Calendar.YEAR) + " The Coca-Cola Company | Todos los derechos reservados");
  ...
  public void actionPerformed(ActionEvent e) {
    if (e.getSource() == miCalculo) {
       ...
       } else {  // Usuario llena todos los campos
